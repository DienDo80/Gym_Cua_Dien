...
st.set_page_config(page_title="Eco Gym V19 - Hoàn Thiện", page_icon="🧬", layout="wide")

# ==========================================
# KÍNH HIỂN VI SOI LỖI
# ==========================================
if "postgresql://" in clean_url:
    st.error("🚨 LỖI CHÍ MẠNG: Đạo hữu đang dán chuỗi có chữ 'postgresql://' vào ô URL. Hãy lấy đường link bắt đầu bằng 'https://' !!")
    st.stop()
...
def init_data():
    try:
        ...
        st.error("🚨 LỖI ĐỌC/GHI VÀO SUPABASE:")
        st.code(str(e))
        st.stop()
